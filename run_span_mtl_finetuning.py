...
from official.nlp.data import create_span_mtl_finetuning_data
...
flags.DEFINE_string('train_data_path', r'C:\Users\klplab\Desktop\ubert\train_span_mtl',
                    'Path to training data for BERT classifier.')

flags.DEFINE_string('meta_data_path', r'C:\Users\klplab\Desktop\ubert\express_meta_span_mtl.json',
                    'Path to training data for BERT classifier.')
# validation
# flags.DEFINE_string('eval_data_path', r'C:\Users\klplab\Desktop\ubert\express_validation_span_mtl',
#                     'Path to evaluation data for BERT classifier.')

# test
flags.DEFINE_string('eval_data_path', r'C:\Users\klplab\Desktop\ubert\test_span_mtl',
                    'Path to evaluation data for BERT classifier.')

flags.DEFINE_string('eval_file_path', r'C:\Users\klplab\Desktop\ubert\test_morph_span_mtl.txt',
                    'Path to evaluation data for BERT classifier.')
...
def get_dataset_fn(input_file_pattern,
  ...
  def _dataset_fn(ctx=None):
    ...
    dataset = input_pipeline.create_span_mtl_dataset(
...
def main(_) :
    ...
    FLAGS.model_dir = 'C:\\Users\\klplab\\Desktop\\ubert\\express_span_mtl\\'
    ...
    if FLAGS.mode == 'predict':
        ...
        eval_datas = create_span_mtl_finetuning_data.read_Seq2Seq(input_file=FLAGS.eval_file_path, 
                        read_function=create_span_mtl_finetuning_data.read_tsv())
        ...
        with tf.io.gfile.GFile(output_predict_file, 'w') as writer:
            ...
            labels_dic = create_span_mtl_finetuning_data.get_labels()
            # reverse_dic
            v_k_labels_dic = dict()
