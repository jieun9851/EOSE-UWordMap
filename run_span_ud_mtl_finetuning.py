...
from official.nlp.data import create_span_ud_mtl_finetuning_data
...
flags.DEFINE_string('train_data_path', r'C:\Users\klplab\Desktop\ubert\z_ex_data\train_span_ud_mtl',
                    'Path to training data for BERT classifier.')

flags.DEFINE_string('meta_data_path', r'C:\Users\klplab\Desktop\ubert\z_ex_data\express_span_ud_mtl.json',
                    'Path to training data for BERT classifier.')
# validation
# flags.DEFINE_string('eval_data_path', r'C:\Users\klplab\Desktop\ubert\z_ex_data\validation_span_ud_mtl',
#                     'Path to evaluation data for BERT classifier.')

# test
flags.DEFINE_string('eval_data_path', r'C:\Users\klplab\Desktop\ubert\z_ex_data\test_span_ud_mtl',
                    'Path to evaluation data for BERT classifier.')

flags.DEFINE_string('eval_file_path', r'C:\Users\klplab\Desktop\ubert\z_ex_data\test_span_up_down.txt',
                    'Path to evaluation data for BERT classifier.')
...
def main(_) :
    ...
    if FLAGS.mode == 'predict':
        ...
        eval_datas = create_span_ud_mtl_finetuning_data.read_Seq2Seq(input_file=FLAGS.eval_file_path, 
                        read_function=create_span_ud_mtl_finetuning_data.read_tsv())
        ...
        with tf.io.gfile.GFile(output_predict_file, 'w') as writer:
            ...
            labels_dic = create_span_ud_mtl_finetuning_data.get_labels()
            # reverse_dic
            v_k_labels_dic = dict()
            ...
            for idx, (probabilities_s, probabilities_e, probabilities_d) in enumerate(zip(preds_s,preds_e,preds_d)):
              ...
              def tag_position(num_list, w_tag):
                for n_id in range(len(num_list)):
                  if num_list[n_id] !=0:
                    if w_tag==0:
                      num_list[n_id]=1
                    elif w_tag==1:
              ...
              result_fixed_tag_start = tag_position(result_fixed_tag_start,result_labels_domain)
              result_fixed_tag_end = tag_position(result_fixed_tag_end,result_labels_domain)
