...
from official.nlp.data import create_span_up_down_finetuning_data
...
flags.DEFINE_string('train_data_path', r'C:\Users\klplab\Desktop\ubert\train_span_up_down',
                    'Path to training data for BERT classifier.')

flags.DEFINE_string('meta_data_path', r'C:\Users\klplab\Desktop\ubert\express_span_up_down.json',
                    'Path to training data for BERT classifier.')
# validation
flags.DEFINE_string('eval_data_path', r'C:\Users\klplab\Desktop\ubert\validation_span_up_down',
                    'Path to evaluation data for BERT classifier.')

# test
flags.DEFINE_string('eval_data_path', r'C:\Users\klplab\Desktop\ubert\test_span_up_down',
                    'Path to evaluation data for BERT classifier.')

flags.DEFINE_string('eval_file_path', r'C:\Users\klplab\Desktop\ubert\test_span_up_down.txt',
                    'Path to evaluation data for BERT classifier.')
...
def get_dataset_fn(input_file_pattern,
  ...
  def _dataset_fn(ctx=None):
    ...
    dataset = input_pipeline.create_span_up_down_dataset(
...
def main(_) :
    ...
    FLAGS.model_dir = 'C:\\Users\\klplab\\Desktop\\ubert\\express_span_up_down_bilstm\\'
    ...
    if FLAGS.mode == 'predict':
        with strategy.scope():
            ...
            preds_s, preds_e, _, _ = get_predictions_and_labels(
                strategy,
                classifier_model,
                eval_input_fn,
        ...
        eval_datas = create_span_up_down_finetuning_data.read_Seq2Seq(input_file=FLAGS.eval_file_path, 
                        read_function=create_span_up_down_finetuning_data.read_tsv())
        ...
        with tf.io.gfile.GFile(output_predict_file, 'w') as writer:
            ...
            labels_dic = create_span_up_down_finetuning_data.get_labels()
            # reverse_dic
            v_k_labels_dic = dict()
            ...
            for idx, (probabilities_s, probabilities_e) in enumerate(zip(preds_s,preds_e)):
              ...
              save_ner_result[idx] = {'tag_text': eval_data.text,
                                      'answer_start' : eval_data.starts,
                                      'pred_start': result_fixed_tag_start,
                                      'answer_end' : eval_data.ends,
                                      'pred_end': result_fixed_tag_end}
